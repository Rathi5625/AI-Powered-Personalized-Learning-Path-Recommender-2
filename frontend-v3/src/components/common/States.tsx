...
export function ErrorState({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center gap-3 rounded-card border border-danger/30 bg-danger/5 px-6 py-10 text-center',
        className,
      )}
      role="alert"
    >
...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center gap-3 rounded-card border border-dashed border-line bg-surface/40 px-6 py-12 text-center',
        className,
      )}
    >
      <div className="text-muted-dim" aria-hidden>

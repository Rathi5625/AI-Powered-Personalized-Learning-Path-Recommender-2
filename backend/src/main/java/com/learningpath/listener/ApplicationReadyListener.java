...
/**
 * Listens for Spring Boot's ApplicationReadyEvent to log clear, unmistakable
 * readiness and port binding confirmation upon successful deployment.
 */
@Component
public class ApplicationReadyListener {
    ...
    public void onApplicationReady() {
        ...
        log.info("""
                ...
                SMTP Enabled        : {}
                ======================================================================
                """, port, activeProfile.isEmpty() ? "default" : activeProfile, importEnabled, smtpEnabled);
    }
}
